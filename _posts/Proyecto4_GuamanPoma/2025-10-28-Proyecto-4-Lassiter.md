...
La presencia simbólica de los animales en *Nueva corónica y buen gobierno* de Felipe Guamán Poma de Ayala enfatiza la complejidad de la relación entre los Incas y los colonizadores. Su uso de las metáforas crea una imagen fuerte de los abusos y violaciones cometidas por los españoles. Más que su escritura, Poma utiliza sus propios dibujos para realzar las emociones sobre las que escribe.
 ...
 <img src="https://raw.githubusercontent.com/dh-miami/SPA_410_Fall25/refs/heads/main/assets/img/PomaIMG1.jpeg" alt="Guaman Poma 1" width="70%" height="70%"> 

Primero, tenemos este dibujo de los seis animales que representan a los españoles. En esta imagen, podemos ver una persona en ropas viejas con las manos en posición de oración. Esta foto acompaña la sección “mal gobierno” en que Poma describe los abusos de los españoles usando los animales como metáforas. Estos animales no son animales importantes en la cultura Inca (con excepción de la serpiente), sino que en realidad son animales más comunes para los europeos. Poma está usando estos animales para crear una imagen clara para el rey. Un ejemplo de una metáfora poderosa es la del león. Poma dice que el encomendero es “como un león: cuando agarra, no perdona con sus uñas, y siendo el más feroz de los animales, no tiene compasión del pobre ni agradece nada”. Así, el león encarna la falta de compasión y empatía de los colonizadores.

 <img src="https://raw.githubusercontent.com/dh-miami/SPA_410_Fall25/refs/heads/main/assets/img/PomaIMG2.jpeg" alt="Guaman Poma 2" width="70%" height="70%"> 
...
En contraste con la primera imagen, Poma utiliza animales de manera muy diferente en este dibujo. Aquí, los animales actúan como ayudantes acompañando al autor en su viaje. Hay palabras como “amigo” escritas en el cuerpo de los animales, representando una relación benéfica y amable. En mi opinión, esta imagen representa el viaje de Poma (etiquetado “autor” en el dibujo) con la ayuda de estos animales representando honestidad y trabajo duro, valores fundamentales de la cultura inca. Los caballos son muy útiles y fuertes y necesarios para viajes largos en este tiempo. 
 ...
 <img src="https://raw.githubusercontent.com/dh-miami/SPA_410_Fall25/refs/heads/main/assets/img/PomaIMG3.jpeg" alt="Guaman Poma 3" width="70%" height="70%"> 

Finalmente, en el tercer dibujo, Poma presenta una llama, un animal muy importante para la vida andina. Aquí, un hombre tiene la mano en el cuello de la llama mientras que el otro levanta maíz. Según mi opinión, esta imagen representa un sacrificio y el texto no solo refleja la espiritualidad de los Incas sino también el matrato que sufren los incas bajo los españoles. Estos Incas que ofrecen cosas son una representación del robo y la explotación del duro trabajo de los nativos.
