...
| **Th., Sept. 4  (6)** | **Leonor López de Córdoba (2)** Close reading and discussion.  Division of labor: Reported speech for Leonor’s story.   **For next class**: prepare texts for Storymap. |  Intro to Leaflet and spreadsheet data input.  |
| **Week 4**  |  |  |
