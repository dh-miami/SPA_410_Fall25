...
| **Tu., Aug. 19  (1)** | Presentation and goals of the course. What is Life Writing?  What is DH? Discussion. **For next class:** 1\. [A paragraph on you](https://dh-miami.github.io/SPA_410_Fall25/2025/08/18/exercise-1-instructions.html). 2\. Explore a [DH project](https://dh-miami.github.io/SPA_410_Fall25/2025/08/18/exercise-2-instructions.html). | Brief intro to GitHub. |
...
| **Th., Sept. 11  [(8)](https://dh-miami.github.io/SPA_410_Fall25/class-8.html)** | **Collection of women in the 15th century (1)** Who was Álvaro de Luna (readings). Historical and cultural context [Libro de las virtuosas e claras mugeres](https://archbio.miami.edu/works/libro-de-las-claras-e-virtuosas-mugeres) What is a corpus of texts? Formats. **For next day:** Reading and bring examples of “virtues” found in the readings.  |  Voyant tools. Creation of stopword list.  |
| **Week 5**  |  |  |
| **Tu., Sept. 16 [(9)](https://dh-miami.github.io/SPA_410_Fall25/class-9.html)** | **Collection of women in the 15th century (2)** Linguistic challenges. Discussion of “virtues”. Text mining reading discussion. **For next class:** Read a selection of biographies: women’s virtues compared to men. |  Experiments with Voyant and Antconc.  |
| **Th., Sept. 18  (10)** | **Collection of women in the 15th century (3)** Discussion: Virtues in women vs men. Guest: **Elizabeth Cornick** and her class. <span style="color:red;">Room: Whitten Learning Center 184</span>  **For next class:** prepare paper From Close to Distant Reading with Voyant and/or AntConc. |  Distant reading and visualizing patterns.  |
...
| **Th., Oct. 9 (16)** | **Catalina de Erauso (4)** Digital storytelling of *Vida y sucesos de la Monja Alférez*.  |  Leaflet and spreadsheet data input.  |
| **Week 9**  |  |  |
...
| **Week 11**  |  |  |
| **Tu., Oct. 28 (20)** | **Juan Francisco Manzano, *Autobiografía de un esclavo* (1839) (1)** Manzano’s context and life.  A primary source:  [Ms. original](https://juanfranciscomanzano.com/es/manuscrito/) Natural Language Processing VS Retrieval-Augmented Generation (RAG) Discussion: Prompting with AI.  **For next class:** bring potential questions to the text.  |  Install GPT4All Intro to RAG |
