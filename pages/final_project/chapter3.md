...
El Capítulo 3 fue analizado a partir de una línea temporal creada por Skye Mata, Lauren Barnwell y Leanna Navo. Este capítulo es parte del libro *Borderlands/La Frontera* de la autora Gloria Anzaldúa, una obra sobre los chicanos, y específicamente su historia que está enraizada en la opresión, tanto interna como externa. La obra destaca la habilidad de los chicanos para prevalecer a pesar de todas las adversidades. Este capítulo explora la espiritualidad chicana, la femeninidad en su cultura, y el impacto de la colonización en su identidad. Se centra en el símbolo de la serpiente, como medio para retratar la opresión espiritual, pero también su adaptabilidad y supervivencia. La línea temporal es relevante porque este capítulo presenta los lugares y acontecimientos como capas que se conectan con el tiempo: antes del patriarcado tolteca/azteca, durante la conversión colonial y en la vida moderna chicana de la frontera. Usar una línea temporal nos ayuda a organizar cómo cambia el significado espiritual y social de cada lugar, lo cual es clave en el argumento del capítulo. También es útil para ver la causa y efecto de cada evento histórico en la identidad de la narradora, por eso la línea temporal es una herramienta ideal.

Mientras Anzaldua provee una explicación previa a algunos conceptos extranjeros, queremos ofrecer primero un contexto adicional para los lectores que no están familiarizados con los principios fundamentales de las sociedades paganas y la cultura o territorio Azteca. Anzaldúa salta entre períodos temporales y conceptos, así la línea temporal nos ayuda a organizar mejor sus puntos y visualizar la evolución de la cultura chicana que retrata a lo largo del capítulo. 

[Hoja de cálcuno para las entradas de la línea del tiempo](https://docs.google.com/spreadsheets/d/1oTVbdR2q0WR-bKXHeQ1suMg5aZbwbnurIT2mrSmZ4x0/edit?usp=sharing)
...
- ¿Cómo cambian las representaciones de los dioses en relación con la dualidad, y de qué manera estos cambios transforman la estructura espiritual y social de las culturas que los adoptan? (Remi)

- ¿Cómo se originó la adopción de la Virgen de Guadalupe y qué papel desempeñó durante la colonización? (Remi)

- ¿Por qué ella mezcla ingles, español y náhuatl en este capítulo y comó apoyan su narrativa? (Lauren)
